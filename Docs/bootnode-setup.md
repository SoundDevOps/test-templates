...
ssh-keygen -t rsa
```
![SSH-term](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/gen_ssh_term.png)
...
![PuTTY](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/Putty.png)
...
![wizard-2](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/deployment2.png)
...
![Deployment in progress](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/deploy_new_deployment.png)
...
![resources](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/deployed-resources.png)
...
![ls_home](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/ls_home.png)
...
![ls_logs](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/ls_logs.png)
...
![pm2_list_azureuser](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/pm2_list_azureuser.png)
![pm2_list_root](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/pm2_list_root.png)
...
![grep_enode](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/grep_enode.png)

copy enode url address, its format is `enode://<128 hex characters>@ip_address:30300`.
In repository, open file [`TestTestNet/mining-node/node.toml`](https://github.com/soundchain/test-templates/blob/dev/TestTestNet/mining-node/node.toml) and replace the value in `bootnodes` parameter with the url above like so:
```
...
...
![initial_keys_generated](https://raw.githubusercontent.com/soundchain/test-templates/dev/Docs/initial_keys_generated.png)
