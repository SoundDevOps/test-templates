# Steps to deploy azure virtual machine to join Musereum-PoA network
...
ssh-keygen -t rsa
```
![SSH-term](https://raw.githubusercontent.com/musereum/test-templates/dev/Ceremony/gen_ssh_term.png)
...
![PuTTY](https://raw.githubusercontent.com/musereum/test-templates/dev/Ceremony/Putty.png)
...
This is the final step, on which you will create azure virtual machine from a template by filling in a number of fields with data obtained on previous steps. After virtual machine deployment is complete, it will automatically join the Musereum-PoA network and all corresponding activities (voting, payout) will become available to you.
...
[![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fmusereum%2Ftest-templates%2Fdev%2FTestTestNet%2Fmining-node%2Ftemplate.json)

2. You should see a window similar to this, preselected fields (subscription, location) may be different from yours.
![wizard-1a](https://raw.githubusercontent.com/musereum/test-templates/dev/Ceremony/deploy_wizard1a.png)
...
6. **Node Full Name**: Enter your real full name. This will be displayed in the Musereum-PoA network usage info page and visible to other users of the network.
...
![wizard-1](https://raw.githubusercontent.com/musereum/test-templates/dev/Ceremony/deploy_wizard1.png)
...
![wizard-2](https://raw.githubusercontent.com/musereum/test-templates/dev/Ceremony/deploy_wizard2.png)
...
![Deployment in progress](https://raw.githubusercontent.com/musereum/test-templates/dev/Ceremony/deploy_new_deployment.png)
representing deployment process of the resource group. Do not close this window and wait till the process is complete and you'll be automatically forwarded to a newly-created resource group page. At this moment you've successfully joined the Musereum-PoA network!
